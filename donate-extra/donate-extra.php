                  ...
                  <tbody>
                    <tr valign="top">
                      ...
                      <td><input type="text" name="paypal_email" id="paypal_email" value="<?php echo stripslashes($dextra['paypal_email']);?>" /><br>
                        <small><?php _e('This is the address associated with your PayPal account.','dextra');?></small>
                      </td>
                    </tr>
                    <tr valign="top">
                    ...
                    <tr valign="top">
                      ...
                      <td><label><input type="checkbox" name="IPN_email" id="IPN_email" value="1"
                        <?php if($dextra['IPN_email']) echo 'checked="checked"';?> /> Enable IPN debugging results to be sent to you via email
                      </label></td>
                    </tr>
                    <tr valign="top">
                    ...
                    <tr valign="top">
                      ...
                      <td>
                        <select name="wall_url" id="wall_url">
                          <?php echo $this->PageSelect($dextra['wall_url']);?>
                        </select><br><small><?php _e('The default location of your Donation/Recognition Page that contains the <code>[donateextra]</code> shortcode.','dextra');?></small>
                      </td>
                    </tr>
                    <tr valign="top">
                    ...
                    <tr valign="top">
                      ...
                      <td><textarea name="ty_emailmsg" id="ty_emailmsg" cols="40" rows="10" style="width:80%;height:150px;"><?php echo stripslashes($dextra['ty_emailmsg']);?></textarea><br>
                        <strong><?php _e('Replacement Codes', 'dextra');?></strong> <small><?php _e('Email Message Only', 'dextra');?></small><br /><?php _e('<code>{donor}</code> = Donor Name<br \><code>{amount}</code> = Donation Amount<br \><code>{donorwall}</code> = Donor Wall URL','dextra');?>
                      </td>
                    </tr>
                  </tbody>
                </table>
